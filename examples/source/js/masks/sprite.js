...
var bg = InkPaint.Sprite.fromImage('source/assets/bg_plane.jpg');

app.stage.addChild(bg);

var cells = InkPaint.Sprite.fromImage('source/assets/cells.png');

cells.scale.set(1.5);

var mask = InkPaint.Sprite.fromImage('source/assets/flowerTop.png');
mask.anchor.set(0.5);
mask.x = 310;
mask.y = 190;
