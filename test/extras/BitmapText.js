...
describe('InkPaint.extras.BitmapText', function ()
{
    ...
    {
        this.texture = new InkPaint.Texture(new InkPaint.BaseTexture(this.fontImage, null, 1));
        this.font = InkPaint.extras.BitmapText.registerFont(this.fontXML, this.texture);
        this.font2 = InkPaint.extras.BitmapText.registerFont(this.font2XML, this.texture);
    });
    it('should render text even if there are unsupported characters', function ()
    {
        const text = new InkPaint.extras.BitmapText('ABCDEFG', {
            font: this.font.font,
        });
    ...
    {
        const text = new InkPaint.extras.BitmapText('A', {
    ...
    {
        const bmpText = new InkPaint.extras.BitmapText('', {
            font: this.font.font,
            size: 24,
        });
    ...
    it('letterSpacing should add extra space between characters', function ()
    {
        ...
        const bmpText = new InkPaint.extras.BitmapText(text, {
            font: this.font.font,
        });
        const positions = [];
