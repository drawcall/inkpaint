...
describe('InkPaint.TransformStatic', function ()
{
    describe('setFromMatrix', function ()
    {
        it('should decompose negative scale into rotation', function ()
        {
            ...
            const transform = new InkPaint.TransformStatic();
            const parent = new InkPaint.TransformStatic();
            const otherTransform = new InkPaint.TransformStatic();
