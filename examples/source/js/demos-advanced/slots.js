...
InkPaint.loader
    .add("source/assets/eggHead.png", "source/assets/eggHead.png")
    .add("source/assets/flowerTop.png", "source/assets/flowerTop.png")
    .add("source/assets/helmlok.png", "source/assets/helmlok.png")
    .add("source/assets/skully.png", "source/assets/skully.png")
    .load(onAssetsLoaded);
...
function onAssetsLoaded() {
    ...
    for (var i = 0; i < 5; i++) {
        ...
        // Build the symbols
        for (var j = 0; j < 4; j++) {
            var symbol = new InkPaint.Sprite(
