...
describe('InkPaint.RoundedRectangle', function ()
{
    it('should create a new rounded rectangle', function ()
    {
        const rrect = new InkPaint.RoundedRectangle(5, 5, 1, 1);
    ...
    {
        const rrect1 = new InkPaint.RoundedRectangle(0, 0, 100, 100, 40);
    ...
    {
        const rrect1 = new InkPaint.RoundedRectangle(0, 0, 200, 200, 50);
        ...
        const rrect2 = new InkPaint.RoundedRectangle(0, 0, 10, 0, 1);

        expect(rrect2.contains(0, 0)).to.be.false;

        const rrect3 = new InkPaint.RoundedRectangle(0, 0, 0, 10, 1);
