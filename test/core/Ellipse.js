...
describe('InkPaint.Ellipse', function ()
{
    it('should create a new ellipse', function ()
    {
        const ellipse1 = new InkPaint.Ellipse();
        ...
        const ellipse2 = new InkPaint.Ellipse(10, 10, 5, 5);
    ...
    {
        const ellipse1 = new InkPaint.Ellipse(10, 10, 5, 5);
    ...
    it('should check if point is within ellipse', function ()
    {
        ...
        const ellipse2 = new InkPaint.Ellipse(10, 10, 0, 0);
