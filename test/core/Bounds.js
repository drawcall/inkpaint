...
describe("getBounds", function() {
    ...
    it("should register correct width/height with a Text Object", function() {
        ...
        const text = new InkPaint.Text("i am some text");
    ...
    it("should ensure bounds respect the trim of a texture ", function() {
        const parent = new InkPaint.Container();
        const baseTexture = new InkPaint.BaseRenderTexture(100, 100);

        const orig = new InkPaint.Rectangle(0, 0, 100, 50);
        const frame = new InkPaint.Rectangle(2, 2, 50, 50);
        const trim = new InkPaint.Rectangle(25, 0, 50, 50);

        const trimmedTexture = new InkPaint.Texture(baseTexture, frame, orig, trim);

        const sprite = new InkPaint.Sprite(trimmedTexture);
