...
describe('InkPaint.WebGLRenderer', function ()
{
    describe('instance', function ()
    {
        ...
        {
            this.renderer = new InkPaint.WebGLRenderer(1, 1, { legacy: true });

            expect(InkPaint.glCore.VertexArrayObject.FORCE_NATIVE).to.equal(true);
        ...
        {
            this.renderer = new InkPaint.WebGLRenderer(1, 1);
            this.renderer.clear();
        }));
    });
    ...
    describe('.setObjectRenderer()', function ()
    {
        if (withGL())
        {
            before(function ()
            {
                this.renderer = new InkPaint.WebGLRenderer();
            });
