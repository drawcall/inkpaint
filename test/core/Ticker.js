...
const Ticker = InkPaint.ticker.Ticker;
const shared = InkPaint.ticker.shared;

describe("InkPaint.ticker.Ticker", function() {
    before(function() {
        this.length = ticker => {
    ...
    it("should protect destroying shared ticker", function() {
        ...
        expect(shared.started).to.be.false;
    });
    ...
    it("should respect priority order", function() {
        ...
        shared
            .add(listener1, null, InkPaint.UPDATE_PRIORITY.LOW)
            .add(listener4, null, InkPaint.UPDATE_PRIORITY.INTERACTION)
            .add(listener3, null, InkPaint.UPDATE_PRIORITY.HIGH)
            .add(listener2, null, InkPaint.UPDATE_PRIORITY.NORMAL);
    ...
    it("should remove once listener in a stack", function() {
        ...
        shared.add(listener1, null, InkPaint.UPDATE_PRIORITY.HIGH);
        shared.addOnce(listener2, null, InkPaint.UPDATE_PRIORITY.NORMAL);
        shared.add(listener3, null, InkPaint.UPDATE_PRIORITY.LOW);
    ...
    it("should call inserted item with a lower priority", function() {
        ...
        const mainListener = sinon.spy(() => {
            shared.add(highListener, null, InkPaint.UPDATE_PRIORITY.HIGH);
            shared.add(lowListener, null, InkPaint.UPDATE_PRIORITY.LOW);
        });

        shared.add(mainListener, null, InkPaint.UPDATE_PRIORITY.NORMAL);
    ...
    it("should remove emit low-priority item during emit", function() {
        ...
        const listener2 = sinon.spy();
        const listener1 = sinon.spy(() => {
            shared.add(listener2, null, InkPaint.UPDATE_PRIORITY.LOW);
        });

        shared.add(listener1, null, InkPaint.UPDATE_PRIORITY.NORMAL);
        ...
        shared.remove(listener1).remove(listener2);
    ...
    it("should remove items before and after current priority", function() {
        ...
        shared.add(listener2, null, InkPaint.UPDATE_PRIORITY.HIGH);
        shared.add(listener3, null, InkPaint.UPDATE_PRIORITY.LOW);
        shared.add(listener4, null, InkPaint.UPDATE_PRIORITY.LOW);

        const listener1 = sinon.spy(() => {
            shared.remove(listener2).remove(listener3);
        ...
        shared.remove(listener1).remove(listener4);
    ...
    it("should destroy on listener", function(done) {
        ...
        ticker.add(listener);
        ticker.add(listener2, null, InkPaint.UPDATE_PRIORITY.LOW);
        ticker.start();
    });
    ...
    it('should Ticker call destroyed listener "next" pointer after destroy', function(done) {
        ...
        ticker.add(listener1, null, InkPaint.UPDATE_PRIORITY.HIGH);
        ticker.add(listener2, null, InkPaint.UPDATE_PRIORITY.HIGH);
        ticker.add(listener3, null, InkPaint.UPDATE_PRIORITY.HIGH);
