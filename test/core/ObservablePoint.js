...
describe('InkPaint.ObservablePoint', function ()
{
    it('should create a new observable point', function ()
    {
        const cb = sinon.spy();
        const pt = new InkPaint.ObservablePoint(cb, this);
    ...
    it('should copy a new observable point', function ()
    {
        ...
        const p1 = new InkPaint.ObservablePoint(cb, this, 10, 20);
        const p2 = new InkPaint.ObservablePoint(cb, this, 5, 2);
        const p3 = new InkPaint.ObservablePoint(cb, this, 5, 6);
