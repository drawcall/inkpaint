...
describe('InkPaint.Container', function ()
{
    ...
    describe('addChild', function ()
    {
        ...
        {
            const container = new InkPaint.Container();
            const child = new InkPaint.Container();
    ...
    describe('addChildAt', function ()
    {
        it('should allow placements at start', function ()
        {
            ...
            container.addChild(new InkPaint.DisplayObject());
    ...
    describe('removeChild', function ()
    {
        it('should ignore non-children', function ()
        {
            ...
            container.removeChild(new InkPaint.DisplayObject());
        ...
        {
            const container = new InkPaint.Container();
            const child1 = new InkPaint.DisplayObject();
            const child2 = new InkPaint.DisplayObject();
    ...
    describe('getChildIndex', function ()
    {
        it('should return the correct index', function ()
        {
            ...
            container.addChild(new InkPaint.DisplayObject(), child, new InkPaint.DisplayObject());
    ...
    describe('setChildIndex', function ()
    {
        ...
        it('should set index', function ()
        {
            ...
            container.addChild(child, new InkPaint.DisplayObject(), new InkPaint.DisplayObject());
        ...
        it('should call onChildrenChange', function ()
        {
            ...
            container.addChild(child, new InkPaint.DisplayObject());
    ...
    describe('swapChildren', function ()
    {
        ...
        it('should throw if children do not belong', function ()
        {
            ...
            expect(() => container.swapChildren(child, new InkPaint.DisplayObject()))
                .to.throw('The supplied DisplayObject must be a child of the caller');
            expect(() => container.swapChildren(new InkPaint.DisplayObject(), child))
                .to.throw('The supplied DisplayObject must be a child of the caller');
        });
    ...
    describe('removeChildren', function ()
    {
        it('should remove all children when no arguments supplied', function ()
        {
            ...
            container.addChild(new InkPaint.DisplayObject(), new InkPaint.DisplayObject(), new InkPaint.DisplayObject());
    ...
    describe('destroy', function ()
    {
        ...
        {
            let container = new InkPaint.Container();
            let child = new InkPaint.DisplayObject();
            ...
            container = new InkPaint.Container();
            child = new InkPaint.DisplayObject();
