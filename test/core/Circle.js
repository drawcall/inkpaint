...
describe('InkPaint.Circle', function ()
{
    ...
    {
        const circ1 = new InkPaint.Circle(10, 10, 5);
    ...
    it('should check if point is within circle', function ()
    {
        ...
        const circ2 = new InkPaint.Circle(10, 10, 0);
