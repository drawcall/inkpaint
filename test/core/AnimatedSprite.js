...
describe("InkPaint.extras.AnimatedSprite", function() {
    describe("instance", function() {
        beforeEach(function() {
            this.textures = [InkPaint.Texture.EMPTY];
        });
        ...
        it("should be correct with default options", function() {
            this.sprite = new InkPaint.extras.AnimatedSprite(this.textures);
            expect(this.sprite._autoUpdate).to.be.true;
        });

        it("should be correct with autoUpdate=false", function() {
            this.sprite = new InkPaint.extras.AnimatedSprite(this.textures, false);
    ...
    describe(".stop()", function() {
        before(function() {
            this.sprite = new InkPaint.extras.AnimatedSprite(
                [InkPaint.Texture.EMPTY],
                false
            );
        });
