...
describe('InkPaint.Matrix', function ()
{
    it('should create a new matrix', function ()
    {
        const matrix = new InkPaint.Matrix();
    ...
    {
        const m1 = new InkPaint.Matrix();
        const m2 = new InkPaint.Matrix();
    ...
    it('should prepend matrix', function ()
    {
        ...
        const m3 = new InkPaint.Matrix();
        const m4 = new InkPaint.Matrix();
    ...
    {
        expect(InkPaint.Matrix.IDENTITY instanceof InkPaint.Matrix).to.be.true;
        expect(InkPaint.Matrix.TEMP_MATRIX instanceof InkPaint.Matrix).to.be.true;
    });
    ...
    {
        const matrix = new InkPaint.Matrix();
        const transformInitial  = new InkPaint.Transform();
        const transformDecomposed = new InkPaint.Transform();
    ...
    {
        const matrix = new InkPaint.Matrix();
        const transform  = new InkPaint.Transform();
