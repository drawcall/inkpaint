...
var bg = InkPaint.Sprite.fromImage(
    paths("source/assets/pixi-filters/bg_depth_blur.jpg")
);
...
var littleDudes = InkPaint.Sprite.fromImage(
    paths("source/assets/pixi-filters/depth_blur_dudes.jpg")
);
...
var littleRobot = InkPaint.Sprite.fromImage(
    paths("source/assets/pixi-filters/depth_blur_moby.jpg")
);
