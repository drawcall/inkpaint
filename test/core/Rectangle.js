...
describe('InkPaint.Rectangle', function ()
{
    it('should create a new rectangle', function ()
    {
        const rect = new InkPaint.Rectangle(5, 5, 1, 1);
    ...
    {
        const rect1 = new InkPaint.Rectangle(10, 10, 10, 10);
    ...
    {
        const rect1 = new InkPaint.Rectangle(10, 10, 10, 10);
        const rect2 = new InkPaint.Rectangle(2, 2, 5, 5);
    ...
    it('should check if point is within rectangle', function ()
    {
        ...
        const rect2 = new InkPaint.Rectangle(10, 10, 10, 0);
    ...
    {
        const rect1 = new InkPaint.Rectangle(10, 10, 10, 10);
        const rect2 = new InkPaint.Rectangle(15, 15, 10, 10);
        ...
        const rect3 = new InkPaint.Rectangle(0, 0, 0, 0);
        const rect4 = new InkPaint.Rectangle(10, 10, 10, 10);
    ...
    {
        // Pad with X & Y
        const rect = new InkPaint.Rectangle(10, 10, 10, 10);
        ...
        // Pad with nothing
        const rect2 = new InkPaint.Rectangle(10, 10, 10, 10);
        ...
        // Pad with Y
        const rect3 = new InkPaint.Rectangle(10, 10, 10, 10);
    ...
    {
        const rect1 = new InkPaint.Rectangle(0, 0, 10, 10);
        const rect2 = new InkPaint.Rectangle(-10, -10, 5, 5);
        ...
        const rect3 = new InkPaint.Rectangle(0, 0, 20, 20);
        const rect4 = new InkPaint.Rectangle(10, 0, 20, 20);
        ...
        const rect5 = new InkPaint.Rectangle(10, 10, 20, 25);
        const rect6 = new InkPaint.Rectangle(22, 24, 20, 20);
        ...
        const rect7 = new InkPaint.Rectangle(11, 10, 20, 25);
        const rect8 = new InkPaint.Rectangle(10, 9, 13, 10);
    ...
    {
        const rect = InkPaint.Rectangle.EMPTY;
