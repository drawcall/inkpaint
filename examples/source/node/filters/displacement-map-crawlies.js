...
var padding = 100;
var bounds = new InkPaint.Rectangle(
    -padding,
    -padding,
...
for (var i = 0; i < 20; i++) {
    var maggot = InkPaint.Sprite.fromImage(paths('source/assets/maggot.png'));
    ...
    maggot.original = new InkPaint.Point();
    maggot.original.copy(maggot.scale);
    maggots.push(maggot);
}

var displacementSprite = InkPaint.Sprite.fromImage(paths('source/assets/pixi-filters/displace.png'));
...
var ring = InkPaint.Sprite.fromImage(paths('source/assets/pixi-filters/ring.png'));
...
var bg = InkPaint.Sprite.fromImage(paths('source/assets/bg_grass.jpg'));
