...
describe('InkPaint.TextStyle', function ()
{
    it('reset reverts style to default', function ()
    {
        const textStyle = new InkPaint.TextStyle();
    ...
    {
        const textStyle = new InkPaint.TextStyle({ fontSize: 1000 });
    ...
    {
        const style = new InkPaint.TextStyle({ fontSize: 72 });
    ...
    {
        const defaultStyle = new InkPaint.TextStyle();
        const style = new InkPaint.TextStyle();
