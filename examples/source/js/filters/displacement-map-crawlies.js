...
for (var i = 0; i < 20; i++) {
    var maggot = InkPaint.Sprite.fromImage('source/assets/maggot.png');
...
var displacementSprite = InkPaint.Sprite.fromImage('source/assets/pixi-filters/displace.png');
...
var ring = InkPaint.Sprite.fromImage('source/assets/pixi-filters/ring.png');
...
var bg = InkPaint.Sprite.fromImage('source/assets/bg_grass.jpg');
