...
describe('InkPaint.Polygon', function ()
{
    describe('constructor', function ()
    {
        it('should accept a spread of values', function ()
        {
            const polygon = new InkPaint.Polygon(0, 0, 10, 0, 0, 10);
        ...
        {
            const polygon = new InkPaint.Polygon(
                new InkPaint.Point(0, 0),
                new InkPaint.Point(10, 0),
                new InkPaint.Point(0, 10)
            );
    ...
    describe('clone', function ()
    {
        ...
        {
            const polygon1 = new InkPaint.Polygon(0, 0, 10, 0, 0, 10);
    ...
    describe('close', function ()
    {
        ...
        {
            const polygon = new InkPaint.Polygon(0, 0, 10, 0, 0, 10, 0, 0);
    ...
    describe('contains', function ()
    {
        ...
        {
            const polygon = new InkPaint.Polygon(0, 0, 10, 0, 10, 10, 0, 10, 0, 0);
